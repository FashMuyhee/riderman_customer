...
const CompanyInfoSheet = ({sheetId}: SheetProps) => {
  const ref = React.useRef<ActionSheetRef>(null);

  return (
    <ActionSheet id={sheetId} ref={ref} containerStyle={ACTION_SHEET_STYLES} openAnimationConfig={ACTION_SHEET_ANIMATION}>
      <View h="full" w="full">
        <View px="10px" w="full">
          <Text onPress={() => ref.current?.hide()} color="main">
            Go Back
          </Text>
        ...
        <ScrollView style={{paddingHorizontal: 10, marginTop: 10}}>
          ...
          <Text fontSize={hp(1.5)}>
            ...
            You wanna a Pepsi, pall, you're gonna pay for it. What did she say? It's your mom, she's tracked you down. Quick, let's cover
            the time machine. Okay. Re-elect Mayor Goldie Wilson. Progress is his middle name. But, what are you blind McFly, it's there.
            How else do you explain that wreck out there? Yeah, well history is gonna change. Never mind that, never mind that now, never
            mind that, never mind- I over slept, look I need your help. I have to ask Lorraine out but I don't know how to do it. I have to
            ask Lorraine out but I don't know how to do it. Well, it will just happen. Like the way I met your father. Um, yeah, I'm on my
            way. No. What?
          </Text>
        </ScrollView>
      </View>
