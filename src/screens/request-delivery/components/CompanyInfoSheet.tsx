...
const CompanyInfoSheet = React.forwardRef<BottomSheet, CompanyInfoSheetProps>(({onClose}, ref) => {
  ...
  return (
    <BottomSheetWrapperSnappy dragClose={false} index={-1} ref={ref} snapPoints={snapPoints}>
      <View px="10px" w="full">
      ...
      <BottomSheetScrollView style={{paddingHorizontal: 10, marginTop: 10}}>
        ...
        <Text fontSize={hp(1.5)}>
          Doc. Wait a minute, Doc. What are you talking about? What happens to us in the future? What do we become assholes or something?
          You got a real attitude problem, McFly. You're a slacker. You remind me of you father when he went her, he was a slacker too. You
          wanna a Pepsi, pall, you're gonna pay for it. What did she say? It's your mom, she's tracked you down. Quick, let's cover the time
          machine. Okay. Re-elect Mayor Goldie Wilson. Progress is his middle name. But, what are you blind McFly, it's there. How else do
          you explain that wreck out there? Yeah, well history is gonna change. Never mind that, never mind that now, never mind that, never
          mind- I over slept, look I need your help. I have to ask Lorraine out but I don't know how to do it. I have to ask Lorraine out
          but I don't know how to do it. Well, it will just happen. Like the way I met your father. Um, yeah, I'm on my way. No. What?
        </Text>
