        ...
        <Pressable mt="10px" mb="10px" onPress={onToggle}>
          <View
            ...
            <HStack space="2" alignItems="center" mt="10px">
              ...
              <VStack w="93%" space="2">
                <Text fontSize="11px">
                  26, Obafemi Awolowo Road, Ikorodu, Lagos
                </Text>
                <Text fontSize="11px">
                  Murtala Mohammed Internationational Airport, Ikeja, Lagos
                </Text>
              </VStack>
            </HStack>
          </View>
    ...
    <>
        ...
        <HStack alignItems="center" justifyContent="space-between">
          <Text fontSize="11px" color="grey.200">
            {isFirst
              ...
              : ' 1. Select Delivery Locations'}
          </Text>
          {!isLast && (
            <IconButton
            _pressed={{bg: 'coolGray.50'}}
              onPress={onToggle}
              icon={<ChevronUpIcon size={3} color="coolGray.300" />}
            />
          )}
        </HStack>
          ...
          <VStack w="93%">
            {isFirst ? (
              <>
                <PlaceAutoComplete
                  placeholder="Pickup:"
                  value={body.pickupLocation}
                  onChange={onFormChange(index, 'pickupLocation')}
                />
                <PlaceAutoComplete
                  placeholder="Delivery:"
                  value={body.deliveryLocation}
                  onChange={onFormChange(index, 'deliveryLocation')}
                />
              </>
            ) : (
              <PlaceAutoComplete
      ...
      <View w="full" mt="15px">
        ...
        <MultiSelectInput
          ...
          values={body.packageTypes}
          onSelect={onFormChange(index, 'packageTypes')}
        />
        <HStack space="2" alignItems="center">
          <TextInput
            ...
            value={body.weight}
            onChange={onFormChange(index, 'weight')}
          />
          <TextInput
            w="48%"
            placeholder="No. of Package"
            keyboardType="numeric"
            value={body.packageNo}
            onChange={onFormChange(index, 'packageNo')}
          />
        </HStack>
        <TextInput
          w="full"
          placeholder="Delivery Instructions (Optional)"
          value={body.packageName}
          onChange={onFormChange(index, 'packageName')}
        />
      </View>
      <View w="full" mt="15px">
        <Text fontSize="11px" color="grey.200">
        ...
        <TextInput
          ...
          value={body.rName}
          onChange={onFormChange(index, 'rName')}
        />
        <PhoneInput
          value={body.rPhone}
          onChange={onFormChange(index, 'rPhone')}
        />
        <TextInput
          w="full"
